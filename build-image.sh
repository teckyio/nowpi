...
Reference: https://github.com/Drewsif/PiShrink

===========================================================================
'

version="v0.1.2-nowpi"
...
# =========== Start: Copy NowPI System =========

mountdir=$(mktemp -d)
mount "$loopback" "$mountdir"

appimages=(nowpi/dist/*.AppImage)

cp -rf home/.config "$mountdir/home/pi/.config"
cp -rf home/* "$mountdir/home/pi/"
cp ${appimages[0]} "$mountdir/home/pi/nowpi.AppImage"
chown -R 1000:1000 "$mountdir/home/pi/.config/"
chown -R 1000:1000 "$mountdir/home/pi/"

umount "$mountdir"

# =========== End:   Copy NowPI System =========
